...
<head>
  <meta charset="utf-8">
  <title>Meteor | 阿里云管理平台 阿里云控制面板 www.bdwml.cn 不倒翁免流</title>
...
<div class="am-g">
 ...
 $res = $DB->query("select * from aliyun_user where name='$user' and pass='$pass' limit 1");
 $res = $DB->fetch($res);
 if($user !== $res['name']){
...
i--; 
 ...
 ?>
    ...
    <form method="post" class="am-form">
      ...
      <br />
      <div class="am-cf">
        <input type="submit" name="submit" value="登录" class="am-btn am-btn-success am-btn-sm am-fl">
        <a href="http://bdwml.cn" class="am-btn am-btn-primary am-btn-sm am-fr">不倒翁官网</a><br><br>
<a href="reg.php" class="am-btn am-btn-success am-btn-sm am-fl">注册</a><br>
      </div>
    </form>
